...
function addEventListenerToChangeUsernameForm(): void {
    const changeUsernameForm = document.getElementById("change-username-form") as HTMLFormElement;
    ...
    changeUsernameForm.addEventListener("submit", (event: Event) => {
        ...
        ajaxSubmitJSON(adminApiRoute + "change-username", data, errFunc, okFunc)
    });
}
...
function addEventListenerToChangeDirectoryRootForm(): void {
    ...
    changeDirForm.addEventListener("submit", (event: Event) => {
        ...
        ajaxSubmitJSON(adminApiRoute + "change-dir-root", data, errFunc, okFunc)
    });
}
...
function addEventListenerToChangeAdminStatusForm(): void {
    ...
    changeAdminStatusForm.addEventListener("submit", (event: Event) => {
        ...
        ajaxSubmitJSON(adminApiRoute + "change-admin-status", data, errFunc, okFunc)
    });
}

function addEventListenerToCreateUserForm(): void {
    ...
    createUserForm.addEventListener("submit", (event: Event) => {
        ...
        ajaxSubmitJSON(adminApiRoute + "create-user", data, errFunc, okFunc);
    });
}

function addEventListenerToDeleteUserForm(): void {
    ...
    deleteUserForm.addEventListener("submit", (event: Event) => {
        ...
        ajaxSubmitJSON(adminApiRoute + "delete-user", data, errFunc, okFunc);
    });
}

export function initiateAdminPage() {
